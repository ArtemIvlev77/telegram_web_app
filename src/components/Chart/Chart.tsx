...
const Chart = () => {
	...
	// }
	return (
		<div className="mb-8 mt-4 pt-5 p-1 bg-[#fff] h-[70%] overflow-scroll">
			<div className="flex justify-between p-3">
				<span className='text-2xl text-black font-semibold -z-100'>{role === ROLES.executor ? 'Сделки' : 'Заявки'} - {orders?.length}</span>
